...
return [
    ...
    [ // $dynamicRoutes
        ...
        187 => [[['_route' => 'show_task', '_controller' => 'App\\Controller\\HomeController::showTask'], ['id'], null, null, false, true, null]],
        213 => [[['_route' => 'edit_task', '_controller' => 'App\\Controller\\HomeController::editTask'], ['id'], ['POST' => 0], null, false, true, null]],
        241 => [
